...
┃ *<𝔇𝔢𝔪𝔬𝔫 𝔪𝔡/>*
┃≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡┃
┣ ${(conn.user.jid == global.conn.user.jid ? '' : `From: https://wa.me/${global.conn.user.jid.split`@`[0 ]}`) || '*𝔇𝔢𝔪𝔬𝔫 𝔟𝔬𝔱 𝔪𝔞𝔡𝔢 𝔟𝔶 𝔠𝔬𝔫𝔣𝔯𝔬𝔫𝔱𝔢𝔯
┃ *<𝔇𝔢𝔪𝔬𝔫 𝔱𝔢𝔰𝔱/>*
┣ ⃟ 🤖 .𝗮𝗹𝗶𝘃𝗲
┣ ⃟ 🤖 .𝗯𝗼𝘁
┣ ⃟ 🤖 .𝗿𝘂𝗻𝘁𝗶𝗺𝗲
